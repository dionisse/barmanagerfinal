...
-- Version: 2.0.1
-- Description: Improved schema with fixed RLS policies and proper data types
...
DROP POLICY IF EXISTS "Allow anonymous read access to user_lots" ON user_lots;
DROP POLICY IF EXISTS "Allow anonymous insert to user_lots" ON user_lots;
DROP POLICY IF EXISTS "Allow anonymous update to user_lots" ON user_lots;
DROP POLICY IF EXISTS "Allow anonymous read access to licenses" ON licenses;
DROP POLICY IF EXISTS "Allow anonymous insert to licenses" ON licenses;
DROP POLICY IF EXISTS "Allow anonymous update to licenses" ON licenses;
...
DROP POLICY IF EXISTS "Allow anonymous read access to user_data" ON user_data;
DROP POLICY IF EXISTS "Allow anonymous insert to user_data" ON user_data;
DROP POLICY IF EXISTS "Allow anonymous update to user_data" ON user_data;
DROP POLICY IF EXISTS "Allow authenticated users to read user_lots" ON user_lots;
DROP POLICY IF EXISTS "Allow authenticated users to read licenses" ON licenses;
DROP POLICY IF EXISTS "Allow authenticated users to read users" ON users;
DROP POLICY IF EXISTS "Allow authenticated users to read user_data" ON user_data;
...
DROP POLICY IF EXISTS "Allow service role to manage user_lots" ON user_lots;
DROP POLICY IF EXISTS "Allow service role to manage licenses" ON licenses;
DROP POLICY IF EXISTS "Allow service role to manage users" ON users;
DROP POLICY IF EXISTS "Allow service role to manage user_data" ON user_data;
...
CREATE POLICY "Allow anonymous delete to user_lots" ON user_lots
...
CREATE POLICY "Allow anonymous delete to licenses" ON licenses
    FOR DELETE TO anon USING (true);
...
CREATE POLICY "Allow anonymous delete to user_data" ON user_data
    FOR DELETE TO anon USING (true);
